...
public class Vehicle implements Serializable {
    ...
    public Vehicle(String owner, String model, int capacity, String vehicleID,
                   ArrayList<String> ridersUIDs ,boolean switchState, String vehicleType, double basePrice)
    {
        this.owner = owner;
        this.model = model;
